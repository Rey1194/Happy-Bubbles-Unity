...
public static class FGFindInFiles
{
	...
	public static void FindAllAssemblyScripts(AssemblyDefinition.UnityAssembly assemblyId)
	{
		...
		for (var i = count; i --> 0; )
		{
			...
			var isFirstPass = lowerPath.FastStartsWith("assets/standard assets/") ||
				lowerPath.FastStartsWith("assets/pro standard assets/") ||
				lowerPath.FastStartsWith("assets/plugins/");
			...
			if (isFirstPass && !isUnity_5_2_1p4_orNewer)
				isEditor = lowerPath.FastStartsWith("assets/plugins/editor/") ||
				lowerPath.FastStartsWith("assets/standard assets/editor/") ||
				lowerPath.FastStartsWith("assets/pro standard assets/editor/");
			else
