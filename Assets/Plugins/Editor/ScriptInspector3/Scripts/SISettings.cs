...
public static class SISettings
{
	...
	public static BoolOption handleOpenAssets = Create("HandleOpenAsset", true);
#else
	...
	{
#if UNITY_2018_3_OR_NEWER
		SettingsService.OpenUserPreferences("Preferences/Script Inspector");
#else
...
#if UNITY_2018_3_OR_NEWER
		GUI.enabled = false;
		EditorGUILayout.Toggle("Expand on Mouse-Over", false, noLayoutOptions);
		GUI.enabled = true;
#else
